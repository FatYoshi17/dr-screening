classdef aten__linear127 < nnet.layer.Layer & nnet.layer.Formattable & ...
        nnet.layer.AutogeneratedFromPyTorch & nnet.layer.Acceleratable
    %aten__linear127 Auto-generated custom layer
    ...
    methods
        function obj = aten__linear127(Name, Type, InputNames, OutputNames)
            obj.Name = Name;
            obj.Type = Type;
            obj.NumInputs = 2;
            obj.NumOutputs = 2;
        ...
        function [linear_9, linear_9_rank] = predict(obj,linear_input_1, linear_input_1_rank)
            ...
            [linear_input_1, linear_input_1_format] = segformer_eager.ops.permuteToReversePyTorch(linear_input_1, '', numel(linear_input_1_rank));
            [linear_input_1] = struct('value', linear_input_1, 'rank', int64(max([2, ndims(linear_input_1), numel(linear_input_1_rank)])));
        ...
        function [linear_9] = tracedPyTorchFunction(obj,linear_input_1,isForward,predict)
            ...
            [linear_9] = segformer_eager.ops.pyLinear(linear_input_1, linear_weight_1, linear_bias_1);
        end
