classdef aten__linear121 < nnet.layer.Layer & nnet.layer.Formattable & ...
        nnet.layer.AutogeneratedFromPyTorch & nnet.layer.Acceleratable
    %aten__linear121 Auto-generated custom layer
    ...
    methods
        function obj = aten__linear121(Name, Type, InputNames, OutputNames)
            obj.Name = Name;
            obj.Type = Type;
            obj.NumInputs = 2;
            obj.NumOutputs = 2;
        ...
        function [linear_input_1, linear_input_1_rank] = predict(obj,linear_argument1_1, linear_argument1_1_rank)
            ...
            if(isa(linear_input_1.value,'dlarray') && any(dims(linear_input_1.value) == 'U'))
                ...
                linear_input_1 = dlarray(single(linear_input_1.value), 'UU');
            end
        ...
        function [linear_input_1] = tracedPyTorchFunction(obj,linear_argument1_1,isForward,predict)
            ...
            [linear_input_1] = segformer_eager.ops.pyLinear(linear_argument1_1, linear_weight_1, linear_bias_1);
        end
